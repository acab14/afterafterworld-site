...
function initSearch() {
  ...
  request.open('GET', '/afterafterworld-site/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/afterafterworld-site/assets/css/just-the-docs-' + theme + '.css');
}
